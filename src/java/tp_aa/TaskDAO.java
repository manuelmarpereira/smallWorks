...
public class TaskDAO {
	...
	public static boolean save(tp_aa.Task task) throws PersistentException {
		try {
			globalconf.TPAAPersistentManager.instance().saveObject(task);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(tp_aa.Task task) throws PersistentException {
		try {
			globalconf.TPAAPersistentManager.instance().deleteObject(task);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(tp_aa.Task task) throws PersistentException {
		try {
			globalconf.TPAAPersistentManager.instance().getSession().refresh(task);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(tp_aa.Task task) throws PersistentException {
		try {
			globalconf.TPAAPersistentManager.instance().getSession().evict(task);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
