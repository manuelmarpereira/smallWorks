...
public class InitWorkDAO {
	...
	public static boolean save(tp_aa.InitWork initWork) throws PersistentException {
		try {
			globalconf.TPAAPersistentManager.instance().saveObject(initWork);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(tp_aa.InitWork initWork) throws PersistentException {
		try {
			globalconf.TPAAPersistentManager.instance().deleteObject(initWork);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(tp_aa.InitWork initWork) throws PersistentException {
		try {
			globalconf.TPAAPersistentManager.instance().getSession().refresh(initWork);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(tp_aa.InitWork initWork) throws PersistentException {
		try {
			globalconf.TPAAPersistentManager.instance().getSession().evict(initWork);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
