...
public class SubTaskDAO {
	...
	public static boolean save(tp_aa.SubTask subTask) throws PersistentException {
		try {
			globalconf.TPAAPersistentManager.instance().saveObject(subTask);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(tp_aa.SubTask subTask) throws PersistentException {
		try {
			globalconf.TPAAPersistentManager.instance().deleteObject(subTask);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(tp_aa.SubTask subTask) throws PersistentException {
		try {
			globalconf.TPAAPersistentManager.instance().getSession().refresh(subTask);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(tp_aa.SubTask subTask) throws PersistentException {
		try {
			globalconf.TPAAPersistentManager.instance().getSession().evict(subTask);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
