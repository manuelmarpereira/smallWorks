...
public class MakeWorkDAO {
	...
	public static boolean save(tp_aa.MakeWork makeWork) throws PersistentException {
		try {
			globalconf.TPAAPersistentManager.instance().saveObject(makeWork);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(tp_aa.MakeWork makeWork) throws PersistentException {
		try {
			globalconf.TPAAPersistentManager.instance().deleteObject(makeWork);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(tp_aa.MakeWork makeWork) throws PersistentException {
		try {
			globalconf.TPAAPersistentManager.instance().getSession().refresh(makeWork);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(tp_aa.MakeWork makeWork) throws PersistentException {
		try {
			globalconf.TPAAPersistentManager.instance().getSession().evict(makeWork);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
