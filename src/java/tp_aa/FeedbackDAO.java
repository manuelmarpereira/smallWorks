...
public class FeedbackDAO {
	...
	public static boolean save(tp_aa.Feedback feedback) throws PersistentException {
		try {
			globalconf.TPAAPersistentManager.instance().saveObject(feedback);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(tp_aa.Feedback feedback) throws PersistentException {
		try {
			globalconf.TPAAPersistentManager.instance().deleteObject(feedback);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(tp_aa.Feedback feedback) throws PersistentException {
		try {
			globalconf.TPAAPersistentManager.instance().getSession().refresh(feedback);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(tp_aa.Feedback feedback) throws PersistentException {
		try {
			globalconf.TPAAPersistentManager.instance().getSession().evict(feedback);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
